...
if($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id'])){
    $idServicio = $_GET['id'];
    $stmt = $conexion->prepare("SELECT idServicio, nombreServicio, descripcionServicio, categoria, fechaAltaServicio, alcance, estadoServicio, patente, img_seguro, img_vtv, capacidad, tipo, nombreCompleto, telefono, correo, servicios.idVehiculo FROM servicios INNER JOIN categorias ON categorias.idCategoria = servicios.idCategoria INNER JOIN estado_servicio ON estado_servicio.idEstadoServicio = servicios.idEstadoServicio INNER JOIN vehiculos ON vehiculos.idVehiculo = servicios.idVehiculo INNER JOIN usuarios ON usuarios.idUsuario = servicios.idUsuario INNER JOIN tipo_vehiculo ON tipo_vehiculo.idTipo = vehiculos.idTipo WHERE idServicio = :idServicio");
    ...
    /* ACCEDER A LAS IMAGENES DEL VEHICULO */
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                ...
                <div class="mb-2">
                    <label for="" class="text-dark"><b>Imágen del seguro</b>:</label>
                    <a href="../../img/vehiculos/<?php echo $datosServicio['img_seguro']; ?>" data-lightbox="img-seguro"><img class="img-fluid" src="../../img/vehiculos/<?php echo $datosServicio['img_seguro']; ?>" alt=""></a> 
                </div>
                <div class="mb-2">
                    <label for="" class="text-dark"><b>Imágen de la VTV</b>:</label>
                    <a href="../../img/vehiculos/<?php echo $datosServicio['img_vtv']; ?>" data-lightbox="img-vtv"><img class="img-fluid" src="../../img/vehiculos/<?php echo $datosServicio['img_vtv']; ?>" alt=""></a> 
                </div>

                <div class="mb-2">
                    <label for="" class="text-dark"><b>Imágenes del vehiculo</b>:</label>

                    <?php 
                        foreach ($fotosVehiculo as $foto) {
                            echo '
                                <a href="../../img/vehiculos/'.$foto['urlFoto'].'" data-lightbox="img-vehiculo"><img class="img-fluid" src="../../img/vehiculos/'.$foto['urlFoto'].'" alt=""></a> 
                            ';
                        }
                    ?>
            ...
            <button type="submit" class="btn btn-primary col-md-4 mx-auto mt-4"> Actualizar Datos </button>
        </form>   
    </div>
</section>
